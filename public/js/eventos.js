// ================== CONFIG ==================
const SHEET_CSV_URL =
  'https://docs.google.com/spreadsheets/d/e/2PACX-1vTMgdJnYOL44Iy5AqdfkHtegw4NU3X5fr0Q5BZwLOkHJafIYyGtU_YycpSsB2n83jgxp30g4d-eZjRK/pub?gid=0&single=true&output=csv';

// Encabezados EXACTOS de la hoja (sin "Enlace")
const COLS = {
  titulo: 'Título',
  tipo: 'Tipo',
  fecha: 'Fecha',
...
// Fecha: soporta YYYY-MM-DD y DD/MM/YYYY
...
// Convierte enlaces de archivo de Google Drive a URL directa
...
function cardHTML(ev){
  ...
  const img = driveToDirect(imgRaw) || 'public/img/hero1.jpg'; // fallback si no hay imagen válida
...
async function loadEvents(){
  ...
  try{
    // anti-cache para forzar la última versión del CSV publicado
